...
SEARCH=$(port_of SEARCH_MCP_PORT 8901)
REPORT=$(port_of REPORT_MCP_PORT 8902)
PLANNER=$(port_of PLANNER_PORT 8903)
RESEARCHER=$(port_of RESEARCHER_PORT 8904)
CRITIC=$(port_of CRITIC_PORT 8905)
