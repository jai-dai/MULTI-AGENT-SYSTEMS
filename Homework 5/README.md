...
Агент з homework-lesson-4 (власний ReAct-цикл, без агентних абстракцій) плюс
**локальна база знань**: гібридний пошук (semantic + BM25), злиття через RRF і
cross-encoder reranking. Агент сам вирішує, коли шукати в документах, а коли в
інтернеті.
